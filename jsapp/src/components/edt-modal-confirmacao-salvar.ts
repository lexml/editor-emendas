  ...
  render(): TemplateResult {
    ...
    return html`
      <sl-dialog label=${tituloModal} @sl-hide=${this.emitirEvento}>
        ...
        <sl-button slot="footer" variant="primary" @click=${(): void => this.registrarOpcaoESair('salvar')}>Salvar</sl-button>

        <sl-button slot="footer" variant="default" @click=${(): void => this.registrarOpcaoESair('nao-salvar')}>Não salvar</sl-button>

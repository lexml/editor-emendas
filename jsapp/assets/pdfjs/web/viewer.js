...
/***/ (function(module, exports, __webpack_require__) {
  ...
  function isIE() {
    return navigator.appVersion.indexOf("MSIE") >= 0 || navigator.userAgent.indexOf("Trident") >= 0;
  }
  function webViewerPrint() {
    if(isIE()) {
      alert('Terminado o download, clique em \'Salvar\', \'Abrir\' e \'Imprimir arquivo\'.');

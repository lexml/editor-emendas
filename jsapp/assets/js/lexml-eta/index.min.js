        ...
        <div slot="start">
          <sl-tab-group id="tabs-esquerda">
            ...
            <sl-tab-panel name="lexml-eta" class="overflow-hidden">
              ${"emendaTextoLivre"!==this.modo?Ms`<lexml-eta id="lexmlEta" @onchange=${this.onChange}></lexml-eta>`:Ms`<editor-texto-rico id="editor-texto-rico-emenda" registroEvento="justificativa" @onchange=${this.onChange}></editor-texto-rico>`}
            </sl-tab-panel>

...
`;class fy{constructor(){this.dataUltimaModificacao=(new Date).toISOString(),this.aplicacao="",this.versaoAplicacao="",this.modoEdicao=my.EMENDA,this.metadados={},this.proposicao=new gy,this.colegiadoApreciador=new by,this.epigrafe=new yy,this.componentes=[new xy],this.comandoEmenda=new Iy,this.justificativa="",this.local="",this.data=(new Date).toISOString().replace(/T.*/,""),this.autoria=new Cy,this.opcoesImpressao=new ky}}var my,vy;!function(t){t.EMENDA="emenda",t.EMENDA_ARTIGO_ONDE_COUBER="emendaArtigoOndeCouber",t.EMENDA_TEXTO_LIVRE="emendaTextoLivre"}(my||(my={}));class gy{constructor(){this.urn="",this.sigla="",this.numero="",this.ano="",this.ementa="",this.identificacaoTexto=""}}class by{constructor(){this.siglaCasaLegislativa="CN",this.tipoColegiado="Plenário"}}class yy{constructor(){this.texto="",this.complemento=""}}class xy{constructor(){this.urn="",this.articulado=!0,this.dispositivos=new _y}}class _y{constructor(){this.dispositivosSuprimidos=[],this.dispositivosModificados=[],this.dispositivosAdicionados=[]}}class wy{constructor(){this.tipo="",this.id=""}}class Ay extends wy{}class Ey extends wy{}class Oy extends Ey{}class Iy{constructor(){this.comandos=[]}}class Sy{constructor(t,e){this.cabecalho=t,this.citacao=e}}!function(t){t.NAO_IDENTIFICADO="Não identificado",t.PARLAMENTAR="Parlamentar",t.COMISSAO="Comissão",t.CASA_LEGISLATIVA="Casa Legislativa"}(vy||(vy={}));class Cy{constructor(){this.tipo=vy.PARLAMENTAR,this.imprimirPartidoUF=!0,this.quantidadeAssinaturasAdicionaisSenadores=0,this.quantidadeAssinaturasAdicionaisDeputados=0,this.parlamentares=[]}}class ky{constructor(){this.imprimirBrasao=!0,this.textoCabecalho="",this.reduzirEspacoEntreLinhas=!1,this.tamanhoFonte=14}}class Ny{constructor(){this.ultimoProcessado=void 0,this.adjacentesOmissis=[],this.fecharAspasAposOmissis=!1}getTexto(t){t=t.filter((t=>t.pai.situacao.descricaoSituacao!==au.DISPOSITIVO_SUPRIMIDO||_u(t.pai))),this.adjacentesOmissis=this.buscaDispositivosAdjacentesAsOmissis(t),t.push(...this.adjacentesOmissis),t.sort(cb.compare);const e=db.getArvoreDispositivosDeAlteracaoDeNorma(t),o=new op;this.montaCitacaoComando(o,e);if(this.fecharAspasAposOmissis||db.isFechaAspas(this.ultimoProcessado)){const t=[...e.keys()][0],i=ld(t),r=i.notaAlteracao?" ("+i.notaAlteracao+")":"";return o.toString().replace(/(<\/p>)$/,"”"+r+"$1")}return o.toString()}buscaDispositivosAdjacentesAsOmissis(t){const e=new Array;for(const o of t)if(yu(o)){const i=db.getDispositivoAnteriorDireto(o);if(t.includes(i)||e.push(i),!db.isFechaAspas(o)){const i=db.getDispositivoPosteriorDireto(o);i&&!t.includes(i)&&e.push(i)}}return e}montaCitacaoComando(t,e){const o=[...e.keys()][0];e=e.get(o);const i=_u(o),r=o.tipo.toLowerCase()+(i?" agrupador":""),n=new lb("p").addAtributo("class",r);if(md(o.pai)&&n.add("“"),n.add(new lb("Rotulo").add(o.rotulo)),i)if(o.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO)n.add(db.getTextoDoDispositivoOuOmissis(o)),t.append(n.toString());else{t.append(n.toString());const e=new lb("p").addAtributo("class",r).add(db.getTextoDoDispositivoOuOmissis(o));t.append(e.toString())}else n.add(db.getTextoDoDispositivoOuOmissis(o,!0)),t.append(n.toString());this.ultimoProcessado=o,e.size>0&&o.situacao.descricaoSituacao!==au.DISPOSITIVO_SUPRIMIDO&&this.writeDispositivoTo(t,e),_u(o)||this.writeOmissisFinal(t,o)}writeDispositivoTo(t,e){const o=[...e.keys()];o.sort(cb.compare);for(const i of o){const o=e.get(i),r=db.getDispositivoAnteriorDireto(i);if(du(this.ultimoProcessado)&&!pu(i)?pu(r)||yu(i)||t.append(this.tagOmissisSemRotulo().toString()):this.ultimoProcessado===r||yu(i)||r.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO||t.append(this.tagOmissisSemRotulo().toString()),!pu(i)){const e=_u(i),r=i.tipo.toLowerCase()+(e?" agrupador":"");if(i.situacao.descricaoSituacao!==au.DISPOSITIVO_ORIGINAL){const e=new lb("p").addAtributo("classe",r);yu(i)||e.add(new lb("Rotulo").add(i.rotulo)),e.add(db.getTextoDoDispositivoOuOmissis(i,!0)),t.append(e.toString())}else if(this.hasFilhosPropostos(o)||this.adjacentesOmissis.includes(i)){const e=new lb("p").addAtributo("classe",r);e.add(new lb("Rotulo").add(i.rotulo)),e.add(new lb("Omissis")),t.append(e.toString())}else t.append(new lb("Omissis").toString())}this.ultimoProcessado=i,o&&o.size>0&&this.writeDispositivoTo(t,o)}}tagOmissisSemRotulo(){return new lb("p").addAtributo("class","omissis").add(new lb("Omissis"))}writeOmissisFinal(t,e){if(e.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO)return;let o=e,i=db.getFilhosEstiloLexML(o);for(;i.length;)o=i[i.length-1],i=db.getFilhosEstiloLexML(o);if(pu(o)&&(o=o.pai),o.situacao.descricaoSituacao!==au.DISPOSITIVO_ORIGINAL||this.adjacentesOmissis.includes(o)&&!yu(o)){if(!db.isFechaAspas(o)){const e=db.getDispositivoPosteriorDireto(o);e&&yu(e)&&(t.append(this.tagOmissisSemRotulo().toString()),this.fecharAspasAposOmissis=!0)}}else t.append(this.tagOmissisSemRotulo().toString()),this.fecharAspasAposOmissis=!0}hasFilhosPropostos(t){if(!t||!t.size)return!1;const e=t;let o=!1;for(const[t,i]of e.entries()){if(t.situacao.descricaoSituacao!==au.DISPOSITIVO_ORIGINAL){o=!0;break}!o&&i&&(o=this.hasFilhosPropostos(i))}return o}}class Ty{getTexto(t){const e=new op,o=new Array;Od(t,(t=>{t.situacao.descricaoSituacao!==au.DISPOSITIVO_ORIGINAL&&o.push(t)})),o.sort(cb.compare);const i=o.length,r=o.filter((t=>t.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO||yu(t))).length;return i-r>0&&this.getCitacoesMultiplas(e,o),e.toString()}getCitacoesMultiplas(t,e){let o,i,r=new Array;for(const n of e)o=du(n)||_u(n)?n:Ru(n),o!==i&&(r.length&&this.getCitacaoMultipla(t,r),r=[o],i=o),r.includes(n)||r.push(n);r.length&&this.getCitacaoMultipla(t,r)}getCitacaoMultipla(t,e){const o=new Ny;t.append(o.getTexto(e))}}class qy{constructor(){this.emAlteracao=!1}getTexto(t,e=!0,o=!0){let i=db.getArvoreDispositivos(t);const r=new op,n=[...i.keys()][0];i=i.get(n);const a=_u(n),s=n.tipo.toLowerCase()+(a?" agrupador":""),l=new lb("p").addAtributo("class",s);if(e&&l.add("“"),Eu(n)||l.add(new lb("Rotulo").add(n.rotulo)),_u(n)){r.append(l.toString());const t=new lb("p").addAtributo("class",s).add(db.getTextoDoDispositivoOuOmissis(n));r.append(t.toString())}else{const t=db.getTextoDoDispositivoOuOmissis(n);l.add(Eu(n)?t.trim():t),r.append(l.toString())}return i.size&&(this.ultimoProcessado=n,this.writeDispositivoTo(r,i)),this.writeOmissisFinal(r,n),o?r.toString().replace(/(<\/p>(?:<\/Alteracao>)?)$/,"”$1"):r.toString()}writeDispositivoTo(t,e){var o;const i=Array.from(e.keys());i.sort(cb.compare);for(const r of i){const i=e.get(r);if(md(r)){t.append("<Alteracao>"),this.emAlteracao=!0,this.ultimoProcessado=r,i.size&&this.writeDispositivoTo(t,i),t.append("</Alteracao>");continue}if(pu(r)){this.ultimoProcessado=r,i.size&&this.writeDispositivoTo(t,i);continue}const n=db.getDispositivoAnteriorDireto(r);if(du(this.ultimoProcessado)&&!pu(r)?pu(n)||t.append(this.tagOmissisSemRotulo().toString()):this.ultimoProcessado===n||this.ultimoProcessado.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO&&Nd(n,this.ultimoProcessado)||t.append(this.tagOmissisSemRotulo().toString()),r.situacao.descricaoSituacao!==au.DISPOSITIVO_ORIGINAL||this.hasFilhosPropostos(i)){const e=du(r)?r.caput:r,i=this.emAlteracao?null===(o=r.rotulo)||void 0===o?void 0:o.replace("“",""):r.rotulo,n=_u(r),a=r.tipo.toLowerCase()+(n?" agrupador":"");let s=new lb("p").addAtributo("class",a);if(cd(r)&&s.add("‘"),s.add(new lb("Rotulo").add(i)),n&&(t.append(s.toString()),s=new lb("p").addAtributo("class",a)),s.add(db.getTextoDoDispositivoOuOmissis(e)),r.isDispositivoAlteracao&&dd(r)){s.add("’");const t=ld(r);t.notaAlteracao&&s.add(" ("+t.notaAlteracao+")")}t.append(s.toString())}else t.append(this.tagOmissisSemRotulo().toString());this.ultimoProcessado=r,i.size&&this.writeDispositivoTo(t,i)}}tagOmissisSemRotulo(){return new lb("p").addAtributo("class","omissis").add(new lb("Omissis"))}writeOmissisFinal(t,e){if(e.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO||_u(e))return;let o=e;for(;o.filhos.length;)o=o.filhos[o.filhos.length-1];o.situacao.descricaoSituacao!==au.DISPOSITIVO_ORIGINAL||Td(o)||t.append(this.tagOmissisSemRotulo().toString())}hasFilhosPropostos(t){if(!t.size)return!1;let e=!1;for(const[o,i]of t.entries()){if(o.situacao.descricaoSituacao!==au.DISPOSITIVO_ORIGINAL){e=!0;break}if(!e&&i.size&&(e=this.hasFilhosPropostos(i),e))break}return e}}class Py{constructor(t){this.articulacao=t}getTexto(){const t=new op,e=this.getDispositivosParaCitacao(),o=e.length,i=e.filter((t=>t.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO)).length;return o-i>0&&this.getCitacoesMultiplas(t,e),t.toString()}getDispositivosParaCitacao(){const t=db.getDispositivosNaoOriginais(this.articulacao).filter((t=>!(_u(t)&&t.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO)));t.sort(cb.compare);const e=new Array;return t.forEach((t=>{md(t)?t.pai.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO&&e.push(t):vd(t)?e.indexOf(t.pai)>=0&&e.push(t):Td(t)||e.push(t)})),e}getCitacoesMultiplas(t,e){let o,i,r=new Array,n=[];if(e.forEach((e=>{if(o=(du(e)||_u(e)||Eu(e))&&!vd(e)?e:Lu(e),o!==i){if(r.length){const e=i.situacao.descricaoSituacao!==au.DISPOSITIVO_ADICIONADO||n.indexOf(i)<0,a=n.indexOf(o)<0;a&&(n=[]),t.append((new qy).getTexto(r,e,a))}r=[],r.push(o),i=o}xu(o)&&o.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO&&n.indexOf(o)<0&&(n=this.getDispositivosMesmoGrupoDeAspas(o)),r.indexOf(e)<0&&r.push(e)})),r.length){const e=n.indexOf(i)<0;t.append((new qy).getTexto(r,e,!0))}}getDispositivosMesmoGrupoDeAspas(t){const e=new Array;return Id(t,(t=>!(vd(t)||!_u(t)&&!du(t))&&(t.situacao.descricaoSituacao!==au.DISPOSITIVO_ADICIONADO||(e.push(t),!1)))),e.slice(1)}}const Dy=(t,e)=>{t.splice(t.indexOf(e),1)};class Ry{constructor(t){this.dispositivos=[],t&&this.add(t)}isSituacao(t){return!!this.dispositivos.length&&this.dispositivos[0].situacao.descricaoSituacao===t}isTipo(t){return!!this.dispositivos.length&&this.dispositivos[0].tipo===t}add(t){return!!this.podeAdicionarAoRange(t)&&(this.dispositivos.push(t),!0)}addInicio(t){this.dispositivos.splice(0,0,t)}isUltimo(t){return this.dispositivos.indexOf(t)===this.dispositivos.length-1}getPrimeiro(){return this.dispositivos[0]}getUltimo(){return this.dispositivos[this.dispositivos.length-1]}getQuantidadeDispositivos(){return this.dispositivos.length}getAnterior(t){if(!(t<1))return this.dispositivos[t-1]}getNumeracaoParaComandoEmenda(){let t=this.dispositivos[0].getNumeracaoParaComandoEmenda(this.dispositivos[0]);return this.dispositivos.length>1&&(t+=" a "+this.getUltimo().getNumeracaoParaComandoEmenda(this.getUltimo())),t}print(t,e){this.isRotuloNecessario(e)?this.printRotuloInicio(t,e):t.append(this.dispositivos[0].getNumeracaoParaComandoEmenda(this.dispositivos[0])),this.printSeparadorProximoDispositivo(t,e),this.printRotuloFimSeExistir(t)}printRotuloFimSeExistir(t){if(this.dispositivos.length>=2){const e=this.dispositivos[this.dispositivos.length-1];t.append(e.getNumeracaoParaComandoEmenda(e))}}printSeparadorProximoDispositivo(t,e){const o=this.getRangeDispositivosPosterior(e);this.dispositivos.length>=3?t.append(" a "):2!==this.dispositivos.length||o?this.dispositivos.length>1&&this.dispositivos.length<3&&o&&t.append(", "):t.append(" e ")}printRotuloInicio(t,e){const o=this.getRangeDispositivosPosterior(e);this.hasApenasUmDispositivo()&&!o||o&&!this.isMesmoTipoSituacao(o)?t.append(this.getRotuloCompletoSingular(this.dispositivos[0])):t.append(this.getRotuloCompletoPlural(this.dispositivos[0]))}isMesmoTipoSituacao(t){return t.isTipo(this.dispositivos[0].tipo)&&t.isSituacao(this.dispositivos[0].situacao.descricaoSituacao)}hasApenasUmDispositivo(){return 1===this.dispositivos.length}isRotuloNecessario(t){const e=this.getRangeDispositivosAnterior(t);return!e||!e.isMesmoTipoSituacao(this)||!(!this.isSituacao(au.DISPOSITIVO_ADICIONADO)||this.isMesmoPai(e))}isMesmoPai(t){return this.getPrimeiro().pai===t.getPrimeiro().pai}getRotuloCompletoSingular(t){const e=new op;t.situacao.descricaoSituacao!==au.DISPOSITIVO_ADICIONADO?e.append(t.artigoDefinidoSingular):e.append(" ");const o=t.getNumeracaoComRotuloParaComandoEmenda(t);return o.endsWith(".")?e.append(o.substring(0,o.indexOf("."))):e.append(o),e.toString()}getRotuloCompletoPlural(t){const e=new op;return t.situacao.descricaoSituacao!==au.DISPOSITIVO_ADICIONADO?e.append(t.artigoDefinidoPlural):e.append(" "),e.append(this.getTipoDispositivoPlural(t)),e.append(" "),e.append(t.getNumeracaoParaComandoEmenda(t)),e.toString()}getRangeDispositivosAnterior(t){const e=t.indexOf(this);if(e>0)return t[e-1]}getRangeDispositivosPosterior(t){if(1===t.length)return;const e=t.indexOf(this);return e>=0&&e<t.length-1?t[e+1]:void 0}getTipoDispositivoPlural(t){var e;return t.tipo===Cl.artigo.tipo?"arts.":t.tipo===Cl.paragrafo.tipo?"§§":(null===(e=t.descricaoPlural)||void 0===e?void 0:e.toLocaleLowerCase())+""}podeAdicionarAoRange(t){if(this.isVazio())return!0;const e=this.getUltimo();return e.tipo===t.tipo&&(!!db.isMesmaSituacaoParaComandoEmenda(e,t)&&(!(!du(t)&&t.pai!==e.pai)&&(td(e)===t&&(_u(t)?db.verificaAgrupadoresAdicionadosEmSequencia(e,t):db.isAlteracaoIntegral(e)===db.isAlteracaoIntegral(t)))))}isVazio(){return 0===this.dispositivos.length}toString(){const t=new op;return this.dispositivos.forEach((e=>{t.append(" "),t.append(""+e.rotulo)})),t.toString()}getDispositivos(){return this.dispositivos}getDispositivo(t){return this.dispositivos[t]}}class Ly{constructor(){this.ranges=new Array,this.localizarEmAgrupador=!1,this.informarCaputDoDispositivo=!1}isVazio(){return 0===this.ranges.length}add(t){this.ranges.push(t)}addInicio(t){this.ranges.unshift(t)}getQuantidadeRanges(){return this.ranges.length}getPrimeiroRange(){return this.ranges[0]}getPrimeiroDispositivo(){return this.ranges[0].getPrimeiro()}getUltimoDispositivo(){return this.ranges[this.ranges.length-1].getUltimo()}getRanges(){return this.ranges}setRanges(t){this.ranges=t}getRange(t){return this.ranges[t]}getTextoListaDeDispositivos(){const t=new op,e=this.ranges.length;let o=1;for(const i of this.ranges)o>1&&(o===e?t.append(" e "):t.append(", ")),t.append(i.getNumeracaoParaComandoEmenda()),o++;return t.toString()}static debug(t){const e=new op;for(const o of t)e.append("seq: "+o);console.log(e)}toString(){return this.ranges.toString()}remove(t){Dy(this.ranges,t)}}class My{getSequencias(t){const e=this.getRanges(t);return this.agrupaRanges(e)}getRanges(t){let e=new Array,o=new Ry;for(const i of t)o.add(i)||(e.push(o),o=new Ry,o.add(i));return o.isVazio()||e.push(o),e=My.separaRangesDeDoisDispositivos(e),e}static separaRangesDeDoisDispositivos(t){const e=new Array;for(const o of t)2===o.getQuantidadeDispositivos()?(e.push(new Ry(o.getPrimeiro())),e.push(new Ry(o.getUltimo()))):e.push(o);return e}separaRangesDeDoisDispositivosEmSequencias(t){for(const e of t)e.setRanges(My.separaRangesDeDoisDispositivos(e.getRanges()))}agrupaRanges(t){const e=new Array;let o=new Ly;for(const i of t)o.isVazio()?(o.add(i),e.push(o)):this.isMesmaSequencia(o,i)?o.add(i):(o=new Ly,o.add(i),e.push(o));return e}isMesmaSequencia(t,e){const o=t.getPrimeiroDispositivo(),i=e.getUltimo();return db.isMesmoTipoParaComandoEmenda(o,i)&&db.isMesmaSituacaoParaComandoEmenda(o,i)&&(o.tipo===Cl.artigo.tipo||o.pai===i.pai)&&o.tipo!==Cl.omissis.tipo&&(!xu(o)||db.verificaAgrupadoresAdicionadosEmSequencia(t.getUltimoDispositivo(),e.getPrimeiro()))}separaDispositivosSeguidosDeOmissis(t){const e=new Array;for(const o of t)e.push(...this.separaDispositivosSeguidosDeOmissis2(o));return e}separaDispositivosSeguidosDeOmissis2(t){const e=new Array;let o=new Ly;e.push(o);let i=new Ry;o.add(i);for(const r of t.getRanges()){i.getQuantidadeDispositivos()>0&&(i=new Ry,o.add(i));for(const t of r.getDispositivos()){const r=Ju(t);r&&r.tipo===Cl.omissis.tipo?(this.adicionaouDispositivos(o,i)&&(0===i.getQuantidadeDispositivos()&&o.remove(i),o=new Ly,e.push(o),i=new Ry,o.add(i)),o.informarCaputDoDispositivo=!0,i.add(t),o=new Ly,e.push(o),i=new Ry,o.add(i)):i.add(t)}}return 0===i.getQuantidadeDispositivos()&&o.remove(i),0===o.getQuantidadeRanges()&&Dy(e,o),this.separaRangesDeDoisDispositivosEmSequencias(e),e}adicionaouDispositivos(t,e){return t.getQuantidadeRanges()>1||e.getQuantidadeDispositivos()>0}}class $y{constructor(t){this.dispositivos=t}static compare(t,e){var o,i;return(null===(o=t.dispositivos)||void 0===o?void 0:o.length)?(null===(i=e.dispositivos)||void 0===i?void 0:i.length)?cb.compare(t.dispositivos[0],e.dispositivos[0]):-1:1}}var jy,zy;!function(t){t[t.NENHUM=0]="NENHUM",t[t.DEFINIDO=1]="DEFINIDO",t[t.DEFINIDO_COM_PREPOSICAO_A=2]="DEFINIDO_COM_PREPOSICAO_A"}(jy||(jy={})),function(t){t[t.APENAS_ROTULO=0]="APENAS_ROTULO",t[t.DENOMINACAO_DO_AGRUPADOR=1]="DENOMINACAO_DO_AGRUPADOR",t[t.TODO_AGRUPADOR=2]="TODO_AGRUPADOR",t[t.O_AGRUPADOR=3]="O_AGRUPADOR",t[t.ADICAO=4]="ADICAO"}(zy||(zy={}));class Fy{constructor(){this.artigoAntesDispositivo=jy.NENHUM,this.tipoReferenciaAgrupador=zy.APENAS_ROTULO}getTexto(t,e=!0){const o=new op,i=t.length;let r=1;for(const n of t){r>1&&(r===i?o.append(" e "):o.append(", "));const t=n.getPrimeiroDispositivo(),a=_u(t),s=this.tipoReferenciaAgrupador===zy.DENOMINACAO_DO_AGRUPADOR&&a,l=this.tipoReferenciaAgrupador===zy.TODO_AGRUPADOR&&a,c=this.tipoReferenciaAgrupador===zy.O_AGRUPADOR&&a&&!!t.filhos.length,u=a&&this.tipoReferenciaAgrupador===zy.ADICAO;n.informarCaputDoDispositivo?o.append(this.getReferenciaCaputDoDispositivo(n)):o.append(this.getTextoArtigoAntesSequencia(n,s,l,c)),s?o.append("denominação "+t.pronomePossessivoSingular+" "):c&&o.append("agrupador "),o.append(this.getRotuloTipoDispositivo(n,a)),o.append(" "),o.append(n.getTextoListaDeDispositivos()),e&&!u&&o.append(this.getRotuloPaisSequencia(n)),u&&o.append(Fy.getLocalizacaoAgrupadores(n.getRanges())),r++}return o.toString().replace("ementa ","ementa")}getReferenciaCaputDoDispositivo(t){const e=new op,o=t.getPrimeiroDispositivo();if(o.tipo===Cl.caput.tipo)return this.getTextoArtigoAntesSequencia(t);const i=db.isSequenciaPlural(t);return e.append(this.getTextoArtigoAntesDispositivo(this.artigoAntesDispositivo,_p,i)),e.append(" caput "),1===t.getRange(0).getQuantidadeDispositivos()?e.append(o.pronomePossessivoSingular):e.append(o.pronomePossessivoPlural),e.toString()}getTextoArtigoAntesSequencia(t,e=!1,o=!1,i=!1){const r=t.getPrimeiroDispositivo(),n=e?xp:i?_p:r,a=db.isSequenciaPlural(t);return(o?"feminino"===r.tipoGenero?"toda ":"todo ":"")+this.getTextoArtigoAntesDispositivo(this.artigoAntesDispositivo,n,a)}getTextoArtigoAntesDispositivo(t,e,o){switch(t){case jy.DEFINIDO:return o?e.artigoDefinidoPlural:e.artigoDefinidoSingular;case jy.DEFINIDO_COM_PREPOSICAO_A:return o?e.artigoDefinidoPrecedidoPreposicaoAPlural:e.artigoDefinidoPrecedidoPreposicaoASingular;default:return""}}getRotuloTipoDispositivo(t,e){const o=t.getPrimeiroDispositivo(),i=Fy.getRotuloTipoDispositivo(o,db.isSequenciaPlural(t));return e?Jd(i):i}static getRotuloTipoDispositivo(t,e){return t.getNumeracaoParaComandoEmenda(t).indexOf("único")>=0?"":e?du(t)?"arts.":hu(t)?"§§":String(t.descricaoPlural).toLocaleLowerCase():du(t)?t.situacao.descricaoSituacao!==au.DISPOSITIVO_MODIFICADO||db.isAlteracaoIntegral(t)?"art.":"caput do art.":hu(t)?"§":String(t.descricao).toLowerCase()}getRotuloPaisSequencia(t){return this.getRotuloPais(t.getPrimeiroDispositivo(),t.localizarEmAgrupador)}getRotuloPais(t,e){var o;let i;if(xu(t))return Fy.getRotuloPaisAgrupador(t);const r=new op;for(;!Sd(t);){if(i=t.pai,i&&md(i)){if(t.tipo===Cl.omissis.tipo){const o=db.getDispositivoAnteriorDireto(t);if(o.tipo!==Cl.alteracao.tipo)return r.append("após "),r.append(o.artigoDefinidoSingular),r.append(o.getNumeracaoComRotuloParaComandoEmenda(o)),r.append(this.getRotuloPais(o,e)),r.toString()}break}if(i&&!Sd(i)&&(!xu(i)||du(t)&&e)){const n=vd(t),a=!n&&t.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO,s=n&&!db.isTextoOmitido(t)&&t.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO&&!ub.existeNaNormaAlterada(t);if(a||s)r.append(i.artigoDefinidoPrecedidoPreposicaoASingular);else if(yu(t)){const n=db.getDispositivoAnteriorDireto(t),a=db.getDispositivoPosteriorDireto(t);if(n===i&&a&&a.pai===i){const t=a.pronomePossessivoSingular+" "+(null===(o=a.descricao)||void 0===o?void 0:o.toLowerCase())+" "+a.getNumeracaoParaComandoEmenda(a);r.append("antes "+t),r.append(i.pronomePossessivoSingular)}else if(!cu(n)||!n.pai)return r.append("após "),r.append(n.artigoDefinidoSingular),r.append(n.getNumeracaoComRotuloParaComandoEmenda(n)),r.append(this.getRotuloPais(n,e)),r.toString()}else r.append(i.pronomePossessivoSingular);r.append(i.getNumeracaoComRotuloParaComandoEmenda(i))}else if(du(t)&&Sd(i)&&e){const e=db.getProximoAgrupador(t);e&&(r.append(" antes "),r.append(e.pronomePossessivoSingular),r.append(e.getNumeracaoComRotuloParaComandoEmenda(e)))}if(!i)break;t=i}return r.toString()}static getRotuloPaisAgrupador(t){const e=new op;let o=t.pai;for(;o&&!Sd(o)&&!cu(o);)e.append(" "),e.append(o.pronomePossessivoSingular),e.append(" "),e.append(o.getNumeracaoComRotuloParaComandoEmenda(o)),o=o.pai;return e.toString()}static getLocalizacaoAgrupadores(t){const e=t[t.length-1].getUltimo(),o=$u(e,(t=>t.situacao.descricaoSituacao!==au.DISPOSITIVO_ADICIONADO&&!pu(t)&&!md(t))),i=new op;if(i.append(" "),o)i.append("antes "),i.append(o.pronomePossessivoSingular),i.append(" "),i.append(o.getNumeracaoComRotuloParaComandoEmenda(o)),_u(o)&&i.append(Fy.getRotuloPaisAgrupador(o));else{const e=t[0].getPrimeiro(),o=Mu(e,(t=>du(t)||_u(t)));o?(i.append("após "),i.append(o.artigoDefinido),i.append(" "),i.append(o.getNumeracaoComRotuloParaComandoEmenda(o)),_u(o)&&i.append(Fy.getRotuloPaisAgrupador(o))):i.append("!!! localização não encontrada !!!")}return i.toString()}}class Uy extends $y{constructor(t,e,o){super(t),this.dispositivos=t,this.generoNormaAlterada=e,this.textoTodos=o}getTexto(t,e,o){const i=new op,r=(new My).getSequencias(this.dispositivos),n=this.dispositivos.length>1;e?i.append(n?"Acrescentem-se ":"Acrescente-se "):(i.append(o?"; e ":"; "),i.append(n?"acrescentem-se ":"acrescente-se "));const a=new Fy;if(i.append(a.getTexto(r)),o){const t=r[r.length-1].getPrimeiroDispositivo();du(t)||_u(t)?i.append(this.generoNormaAlterada.artigoDefinidoPrecedidoPreposicaoASingular):(""!==this.textoTodos&&i.append(this.textoTodos),i.append(" "),i.append(this.generoNormaAlterada.pronomePossessivoSingular)),i.append(" ")}return i.toString()}}class By extends $y{constructor(t,e,o){super(t),this.dispositivos=t,this.generoNormaAlterada=e,this.textoTodos=o}getTexto(t,e,o){const i=new op,r=new My,n=r.separaDispositivosSeguidosDeOmissis(r.getSequencias(this.dispositivos));e?i.append("Dê-se nova redação "):(i.append(o?"; e ":"; "),i.append("dê-se nova redação "));const a=new Fy;return a.artigoAntesDispositivo=jy.DEFINIDO_COM_PREPOSICAO_A,a.tipoReferenciaAgrupador=zy.DENOMINACAO_DO_AGRUPADOR,i.append(a.getTexto(n)),o&&(""!==this.textoTodos&&i.append(this.textoTodos),i.append(" "),i.append(this.generoNormaAlterada.pronomePossessivoSingular),i.append(" ")),i.toString()}}class Vy extends $y{constructor(t,e,o,i,r){super(t),this.dispositivos=t,this.alteracao=e,this.urnNormaAlterada=o,this.generoNormaAlterada=i,this.textoTodos=r}getTexto(t,e,o){const i=new op,r=(new My).getSequencias(this.dispositivos),n=db.isSequenciasPlural(r);e?i.append(n?"Suprimam-se ":"Suprima-se "):(e||i.append(o?"; e ":"; "),i.append(n?"suprimam-se ":"suprima-se "));const a=new Fy;return a.artigoAntesDispositivo=jy.DEFINIDO,a.tipoReferenciaAgrupador=zy.O_AGRUPADOR,i.append(a.getTexto(r)),o&&(""!==this.textoTodos&&i.append(this.textoTodos),i.append(" "),i.append(this.generoNormaAlterada.pronomePossessivoSingular),i.append(" ")),i.toString()}escreveDispositivoAlterado(t,e){t.append(e.pronomePossessivoSingular),t.append(Fy.getRotuloTipoDispositivo(e,!1)),t.append(" "),t.append(e.getNumeracaoParaComandoEmenda(e)),t.append(db.getRotuloPais(e))}}class Hy{constructor(t){this.alteracao=t}getTexto(t){const e=new op,o=db.getDispositivosNaAlteracaoParaComando(this.alteracao),i=this.alteracao.base;if(!i)return"Não foi possível gerar o comando de emenda porque a norma alterada não foi informada.";const r=(t=>{const e=Sp(t);return Ap(e.genero)})(i),n=new Array,a=o.filter((t=>t.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO)),s=o.filter((t=>db.getDescricaoSituacaoParaComandoEmenda(t)===au.DISPOSITIVO_MODIFICADO)),l=o.filter((t=>db.getDescricaoSituacaoParaComandoEmenda(t)===au.DISPOSITIVO_ADICIONADO)),c=a.concat(s).concat(l),u=c.length,d=c.reduce(((t,e)=>t||"masculino"===e.tipoGenero),!1);let p="";2===u?p=d?", ambos":", ambas":u>2&&(p=d?", todos":", todas"),a.length&&n.push(new Vy(a,this.alteracao,i,r,p)),s.length&&n.push(new By(s,r,p)),l.length&&n.push(new Uy(l,r,p)),n.sort($y.compare);let h=0;const f=n.length-1;n.forEach((o=>{e.append(o.getTexto(t,0===h,h===f)),h++})),this.escreveLei(e,i);const m=o.reduce(((t,e)=>t||e.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO),!1);return m?(""===p||e.toString().includes(p)?e.append(","):e.append(p),e.append(" na forma proposta ")):(e.append(", como "),this.escreveProposto(e,o.filter((t=>!db.isTextoOmitido(t)||Ku(t))))),e.append(" "),this.escreveDispositivoAlterado(e,this.alteracao.pai),e.append(" "),e.append(t.genero.pronomePossessivoSingular),e.append(" "),e.append(t.nome),this.temCitacao(s,l)?e.append(", nos termos a seguir:"):e.append("."),db.normalizaCabecalhoComandoEmenda(e.toString())}temCitacao(t,e){return!!t.length||!!e.find((t=>!yu(t)))}escreveDispositivoAlterado(t,e){t.append("pel"+e.artigoDefinidoSingular.trim()),t.append(" "),t.append(Fy.getRotuloTipoDispositivo(e,!1)),t.append(" "),t.append(e.getNumeracaoParaComandoEmenda(e)),t.append(db.getRotuloPais(e))}escreveLei(t,e){t.append(Rp(e))}escreveProposto(t,e){const o=e.length>1,i=e.filter((t=>t.tipoGenero===xp.tipoGenero)).length===e.length;t.append("propost"+(i?"a":"o")+(o?"s":""))}}class Gy extends $y{constructor(t){super(t=db.retiraPrimeirosFilhosAdicionadosAgrupador(t)),this.dispositivos=t}getTexto(t,e,o){const i=new op;let r=(new My).getSequencias(this.dispositivos);if(r=this.trataLocalizacaoEmAgrupador(r),e&&o&&this.trataComandoUnicoDeAcrescimoDeAgrupadoresConsecutivos(i,t,r))return i.toString();const n=db.isSequenciasPlural(r);e?i.append(n?"Acrescentem-se ":"Acrescente-se "):(i.append(o?"; e ":"; "),i.append(n?"acrescentem-se ":"acrescente-se "));const a=new Fy;if(a.tipoReferenciaAgrupador=zy.ADICAO,i.append(a.getTexto(r)),o){const o=r[r.length-1],n=o.getPrimeiroDispositivo();!du(n)||o.localizarEmAgrupador?i.append(t.genero.pronomePossessivoSingular):i.append(t.genero.artigoDefinidoPrecedidoPreposicaoASingular),i.append(t.nome),i.append(e?", com a seguinte redação:":", nos termos a seguir:")}return i.toString()}trataLocalizacaoEmAgrupador(t){const e=new Array;for(const o of t){const t=o.getPrimeiroDispositivo();du(t)?e.push(...this.trataLocalizacaoEmAgrupadorSequencia(o)):e.push(o)}return e}trataLocalizacaoEmAgrupadorSequencia(t){const e=new Array,o=new Array;for(const e of t.getRanges())o.push(...e.getDispositivos());let i=!1;for(const t of o)if(this.isInclusaoDeArtigoProximoAAgrupador(t)){i=!0;break}if(!i)return e.push(t),e;let r=new Ly;r.localizarEmAgrupador=!0,e.push(r);let n,a=new Ry;r.add(a);for(const t of o)a.isVazio()||(t.pai!==n.pai?(r=new Ly,r.localizarEmAgrupador=!0,e.push(r),a=new Ry,r.add(a)):db.getDispositivoIrmaoPosterior(n)!==t&&(a=new Ry,r.add(a))),a.add(t),n=t;for(const t of e)t.setRanges(My.separaRangesDeDoisDispositivos(t.getRanges()));return e}isInclusaoDeArtigoProximoAAgrupador(t){return this.isInclusaoNoInicioDeAgrupador(t)||this.isInclusaoImediatamenteAntesDeAgrupador(t)}isInclusaoNoInicioDeAgrupador(t){const e=t.pai;return!(Sd(e)||!xu(e))&&0===e.filhos.indexOf(t)}isInclusaoImediatamenteAntesDeAgrupador(t){const e=t.pai,o=db.getDispositivoIrmaoPosterior(t);return!!o&&e!==o.pai}trataComandoUnicoDeAcrescimoDeAgrupadoresConsecutivos(t,e,o){const i=o[0],r=i.getPrimeiroDispositivo();if(1===o.length&&_u(r)){const n=i.getRanges();if(1===n.length||2===n.length&&1===n[0].getDispositivos().length&&1===n[1].getDispositivos().length&&db.verificaAgrupadoresAdicionadosEmSequencia(n[0].getPrimeiro(),n[1].getPrimeiro())){const i=db.isSequenciasPlural(o);t.append(i?"Acrescentem-se,":"Acrescente-se,"),t.append(Fy.getLocalizacaoAgrupadores(n)),t.append(e.genero.pronomePossessivoSingular),t.append(" "),t.append(e.nome),t.append(", "),t.append(r.artigoDefinido),t.append(i?"s seguintes ":" seguinte ");const a=new Fy;return t.append(a.getTexto(o,!1)),t.append(":"),!0}}return!1}}class Ky{constructor(t){this.dispositivos=t}getTexto(t){var e,o,i,r;if(!this.dispositivos.length)return"";const n=t.genero.contracaoEmArtigoDefinidoSingular+" "+t.nome,a=this.dispositivos.filter((t=>du(t)&&!_u(t.pai))).length,s=this.dispositivos.filter((t=>_u(t))).length,l=new op,c=a+s>1;c?l.append("Acrescentem-se, onde couber, "+n+" "):l.append("Acrescente-se, onde couber, "+n+" ");const u=a>0;if(u&&(l.append(c?"os seguintes ":"o seguinte "),l.append(a>1?"artigos":"artigo")),s>0){const t=this.dispositivos.find((t=>_u(t)));u?(l.append(" e "),l.append(s>1?null===(e=t.descricaoPlural)||void 0===e?void 0:e.toLocaleLowerCase():null===(o=t.descricao)||void 0===o?void 0:o.toLocaleLowerCase())):s>1?l.append(t.artigoDefinidoPlural+" seguintes "+(null===(i=t.descricaoPlural)||void 0===i?void 0:i.toLocaleLowerCase())):l.append(t.artigoDefinido+" seguinte "+(null===(r=t.descricao)||void 0===r?void 0:r.toLocaleLowerCase()))}return l.append(":"),tp(l.toString())}}class Wy extends $y{constructor(t){super(t),this.dispositivos=t}getTexto(t,e,o){const i=new op,r=(new My).getSequencias(this.dispositivos);e?(i.append("Dê-se "),o||i.append("nova redação ")):(i.append(o?"; e ":"; "),i.append("dê-se nova redação "));const n=new Fy;return n.artigoAntesDispositivo=jy.DEFINIDO_COM_PREPOSICAO_A,n.tipoReferenciaAgrupador=zy.DENOMINACAO_DO_AGRUPADOR,i.append(n.getTexto(r).trim()),o&&(i.append(" "+t.genero.pronomePossessivoSingular+" "+t.nome),i.append(e?" a seguinte redação:":", nos termos a seguir:")),i.toString()}}class Qy extends $y{constructor(t){super(t),this.dispositivos=t}getTexto(t,e,o){const i=new op,r=(new My).getSequencias(this.dispositivos),n=db.isSequenciasPlural(r);e?i.append(n?"Suprimam-se ":"Suprima-se "):(i.append(o?"; e ":"; "),i.append(n?"suprimam-se ":"suprima-se "));const a=new Fy;return a.artigoAntesDispositivo=jy.DEFINIDO,a.tipoReferenciaAgrupador=zy.TODO_AGRUPADOR,i.append(a.getTexto(r)),o&&(i.append(" "+t.genero.pronomePossessivoSingular+" "+t.nome),i.append(e?".":", nos termos a seguir:")),i.toString()}}class Xy{constructor(t){this.dispositivosEmenda=t}getTexto(t){let e="";const o=db.getDispositivosComando(this.dispositivosEmenda),i=o.filter((t=>t.situacao instanceof ef&&t.situacao.tipoEmenda===Su.EMENDA_ARTIGO_ONDE_COUBER));if(i.length){if(i.length<o.length)throw new Error("Adição de artigos onde couber e outras alterações na mesma emenda.");return new Ky(i).getTexto(t)}const r=[],n=o.filter((t=>t.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO));n.length&&r.push(new Qy(n));const a=o.filter((t=>t.situacao.descricaoSituacao===au.DISPOSITIVO_MODIFICADO));a.length&&r.push(new Wy(a));const s=o.filter((t=>t.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO));s.length&&r.push(new Gy(s)),r.sort($y.compare);let l=0;const c=r.length-1;return r.forEach((o=>{e+=o.getTexto(t,0===l,l===c),l++})),db.normalizaCabecalhoComandoEmenda(e)}}class Zy{constructor(t,e){this.urn=t,this.articulacao=e}getComandoEmenda(){const t=new Iy,e=db.getDispositivosNaoOriginais(this.articulacao),o=this.getDispositivosRepresentativosDeCadaComando(e);if(o.sort(cb.compare),!o.length)return t;const i=(t=>{const e=Sp(t);let o=Ap(e.genero),i="Projeto";return o===xp&&(i=e.urn.startsWith("medida.provisoria")?"Medida Provisória":"Proposta"),new Ep(i,o)})(this.urn);return o.forEach((o=>{let r,n,a;if(cu(o)){r=new Hy(o).getTexto(i);n=(new Ty).getTexto(o),a=this.getTextoComplementoDispAlteracao(o)}else{r=new Xy(e).getTexto(i);n=new Py(this.articulacao).getTexto(),a=this.getTextoComplementoDispProposicao(e)}const s=new Sy(r,n);a&&(s.complemento=a),t.comandos.push(s)})),t.comandos.length>1&&(t.cabecalhoComum=this.montaCabecalhoComum(i,t.comandos.length),t.comandos.forEach(((t,e)=>{t.rotulo=`Item ${e+1} –`}))),t}getDispositivosRepresentativosDeCadaComando(t){const e=[];let o=!1;return t.forEach((t=>{const i=Cu(t);i&&md(i)?e.includes(i)||i.pai.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO||i.pai.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO||e.push(i):o||(o=!0,e.push(t))})),e}montaCabecalhoComum(t,e){return`Dê-se nova redação ${t.genero.artigoDefinidoPrecedidoPreposicaoASingular} ${t.nome} nos termos dos itens ${this.listarItens(e)} a seguir.`}listarItens(t){return Array(t).fill(0).map(((t,e)=>e+1)).join(", ").replace(/, (\d+?)$/," e $1")}getTextoComplementoDispProposicao(t){const e=t.filter((t=>!vd(t)&&t.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO&&t.situacao.tipoEmenda!==Su.EMENDA_ARTIGO_ONDE_COUBER&&t.pai.situacao.descricaoSituacao!==au.DISPOSITIVO_ADICIONADO));if(e.length&&db.verificaNecessidadeRenumeracaoRedacaoFinal(e))return"Os dispositivos acima propostos e adjacentes deverão ser devidamente renumerados no momento da consolidação das emendas ao texto da proposição pela Redação Final."}getTextoComplementoDispAlteracao(t){const e=Id(t,(t=>_u(t)&&t.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO));if(e)return"O comando de supressão do agrupador não se refere aos dispositivos a ele subordinados."}}class Yy{constructor(t,e,o){this.tipoEmenda=t,this.urn=e,this.articulacao=o}getDispositivosEmenda(){const t=new _y;return this.preencheDispositivos(t),t}preencheDispositivos(t){const e=db.getDispositivosNaoOriginais(this.articulacao),o=e.filter((t=>t.situacao.descricaoSituacao===au.DISPOSITIVO_SUPRIMIDO&&t.pai.situacao.descricaoSituacao!==au.DISPOSITIVO_SUPRIMIDO));if(o.length)for(const e of o){const o=new Ay;o.tipo=this.getTipoDispositivoParaEmenda(e),o.id=e.id,o.rotulo=e.rotulo,this.addUrnNormaAlteradaSeNecessario(e,o),t.dispositivosSuprimidos.push(o)}const i=e.filter((t=>t.situacao.descricaoSituacao===au.DISPOSITIVO_MODIFICADO));if(i.length)for(const e of i){const o=new Ey;if(du(e)){const t=e.caput;o.tipo=this.getTipoDispositivoParaEmenda(t),o.id=t.id,o.texto=this.trataTexto(t.texto)}else o.tipo=this.getTipoDispositivoParaEmenda(e),o.id=e.id,o.texto=this.trataTexto(e.texto);o.rotulo=e.rotulo,e.isDispositivoAlteracao&&this.preencheAtributosAlteracao(e,o),this.addUrnNormaAlteradaSeNecessario(e,o),t.dispositivosModificados.push(o)}const r=this.separaAgrupadores(e.filter((t=>t.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO&&!this.isDispositivoFilhoDeAdicionado(t))));if(r.length)for(const e of r){const o=this.criaDispositivoEmendaAdicionado(e);this.addUrnNormaAlteradaSeNecessario(e,o),t.dispositivosAdicionados.push(o)}}separaAgrupadores(t){const e=t=>t.situacao.descricaoSituacao!==au.DISPOSITIVO_ADICIONADO?[]:_u(t)?[t,...t.filhos.flatMap((t=>e(t)))]:[t];return t.flatMap((t=>e(t)))}isDispositivoFilhoDeAdicionado(t){return!!(t.pai.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO||pu(t.pai)&&t.pai.pai.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO||t.isDispositivoAlteracao&&du(t)&&t.pai.pai.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO)}criaDispositivoEmendaAdicionado(t,e=!0){var o,i,r;const n=new Oy;if(n.tipo=this.getTipoDispositivoParaEmenda(t),t.id||(t.id=ch(t)),n.id=t.id,pu(t)||md(t)||yu(t)||(n.rotulo=t.rotulo),du(t)||md(t)||(n.texto=this.trataTexto(t.texto)),e)if(pu(t)||md(t))n.idPai=null===(o=t.pai)||void 0===o?void 0:o.id;else if(_u(t))n.idPosicaoAgrupador=this.calculaPosicaoAgrupador(t);else{const e=db.getFilhosEstiloLexML(t.pai);t!==e[0]?n.idIrmaoAnterior=e[e.indexOf(t)-1].id:Sd(t.pai)||(n.idPai=null===(i=t.pai)||void 0===i?void 0:i.id)}if(md(t)){const e=t.base;e&&(n.urnNormaAlterada=e)}else t.isDispositivoAlteracao&&(n.existeNaNormaAlterada=null===(r=t.situacao)||void 0===r?void 0:r.existeNaNormaAlterada,this.preencheAtributosAlteracao(t,n));if(!_u(t)){const e=db.getFilhosEstiloLexML(t);pu(t)&&t.pai.alteracoes&&e.push(t.pai.alteracoes),e.length&&(n.filhos=[],e.forEach((t=>{(pu(t)||md(t)||t.situacao.descricaoSituacao===au.DISPOSITIVO_ADICIONADO)&&n.filhos.push(this.criaDispositivoEmendaAdicionado(t,!1))})))}return n}calculaPosicaoAgrupador(t){const e=Yu(t);if(e&&!Sd(e))return _u(e)||du(e)?e.id:Ru(e).id}getTipoDispositivoParaEmenda(t){return cu(t)?"Alteracao":t.tipo}preencheAtributosAlteracao(t,e){if(!yu(t)&&e.texto&&e.texto.indexOf(lu)>=0&&(e.textoOmitido=!0),cd(t)&&(e.abreAspas=!0),dd(t)){e.fechaAspas=!0;const o=ld(t);e.notaAlteracao=o.notaAlteracao}}trataTexto(t){return t.indexOf(lu)>=0?lu:t.trim()}addUrnNormaAlteradaSeNecessario(t,e){var o,i,r;if(vd(t)){const n=null===(r=null===(i=null===(o=Cu(t))||void 0===o?void 0:o.pai)||void 0===i?void 0:i.alteracoes)||void 0===r?void 0:r.base;n&&(e.urnNormaAlterada=n)}}}const Jy=(t,e)=>{var o;let i;if(i=xu(t)?e.lXhier=[]:e.lXcontainersOmissis=[],du(t)){const e=ox(t.caput);tx(t,e.value),i.push(e),ex(null===(o=t.filhos)||void 0===o?void 0:o.filter((t=>!pu(t.pai))),i),Jy(t.caput,e.value)}else ex(t.filhos,i);return i},tx=(t,e)=>{var o,i,r;t.hasAlteracao()&&(e.alteracao={TYPE_NAME:"br_gov_lexml__1.Alteracao",base:"",id:"",content:[]},e.alteracao.base=null!==(i=null===(o=t.alteracoes)||void 0===o?void 0:o.base)&&void 0!==i?i:"",e.alteracao.id=(t=>{const e=[];return lh(t,e),e.join("_")+"_alt1"})(t.caput),null===(r=t.alteracoes.filhos)||void 0===r||r.forEach((t=>{const o=ox(t);e.alteracao.content.push(o),Jy(t,o.value)})))},ex=(t,e)=>{null==t||t.forEach((t=>{const o=ox(t);e.push(o),Jy(t,o.value)}))},ox=t=>{const e={name:{namespaceURI:"http://www.lexml.gov.br/1.0",localPart:t.tipo,prefix:"",key:`{http://www.lexml.gov.br/1.0}${t.tipo}`,string:`{http://www.lexml.gov.br/1.0}${t.tipo}`},value:{TYPE_NAME:"br_gov_lexml__1.DispositivoType"}};return ix(t,e.value),e},ix=(t,e)=>{e.href=pu(t)?sh(t.pai)+"_"+sh(t):sh(t),e.id=ch(t),cd(t)?(e.abreAspas="s",e.rotulo=t.rotulo):pu(t)||yu(t)||(e.rotulo=t.rotulo);const o=pu(t)?t.pai:t;if(vd(o)&&dd(o)){e.fechaAspas="s";const t=ld(o);e.notaAlteracao=t.notaAlteracao||"NR"}xu(t)?e.nomeAgrupador={TYPE_NAME:"br_gov_lexml__1.GenInline",content:rx(t)}:du(t)||(t.texto===lu?e.textoOmitido="s":e.p=[{TYPE_NAME:"br_gov_lexml__1.GenInline",content:rx(t)}])},rx=t=>{const e=/<a[^>]+href="(.*?)"[^>]*>(.*?)<\/a>/gi,o=[],i=t.texto.match(e);if(i)t.texto.startsWith(i[0])||o.push(t.texto.substring(0,t.texto.indexOf(i[0])));else{const e=t.texto.indexOf("” (NR)");o.push(t.texto.substring(0,-1===e?void 0:e))}return null==i||i.forEach(((r,n)=>{var a,s;const l=r.match(e)?r:"";o.push(nx(null!=l?l:""));const c=(null===(a=t.texto)||void 0===a?void 0:a.indexOf(r))+r.length;if(c<t.texto.length-1){const e=i[n+1]?t.texto.indexOf(i[n+1]):t.texto.length;o.push(null===(s=t.texto.substring(c,e))||void 0===s?void 0:s.replace(/strong>/gi,"b>").replace(/em>/gi,"i>"))}})),o},nx=t=>{var e;const o=t.match(/href="(.*?)"*>/i),i=o&&o[1]?o[1]:"",r=t.match(/<a[^>]+href=".*?"[^>]*>(.*?)<\/a>/);return{name:{namespaceURI:"http://www.lexml.gov.br/1.0",localPart:"span",prefix:"",key:"{http://www.lexml.gov.br/1.0}span",string:"{http://www.lexml.gov.br/1.0}span"},value:{TYPE_NAME:"br_gov_lexml__1.GenInline",href:i,content:r&&r[1]?[null===(e=r[1])||void 0===e?void 0:e.trim()]:[""]}}},ax={name:{namespaceURI:"http://www.lexml.gov.br/1.0",localPart:"LexML",prefix:"",key:"{http://www.lexml.gov.br/1.0}LexML",string:"{http://www.lexml.gov.br/1.0}LexML"},value:{TYPE_NAME:"br_gov_lexml__1.LexML",metadado:{TYPE_NAME:"br_gov_lexml__1.Metadado",identificacao:{TYPE_NAME:"br_gov_lexml__1.Identificacao",urn:""}},projetoNorma:{TYPE_NAME:"br_gov_lexml__1.ProjetoNorma",norma:{TYPE_NAME:"br_gov_lexml__1.HierarchicalStructure",parteInicial:{TYPE_NAME:"br_gov_lexml__1.ParteInicial",epigrafe:{TYPE_NAME:"br_gov_lexml__1.GenInline",id:"epigrafe",content:[""]},ementa:{TYPE_NAME:"br_gov_lexml__1.GenInline",id:"ementa",content:[""]},preambulo:{TYPE_NAME:"br_gov_lexml__1.TextoType",id:"preambulo",p:[{TYPE_NAME:"br_gov_lexml__1.GenInline",content:[""]}]}},articulacao:{TYPE_NAME:"br_gov_lexml__1.Articulacao",lXhier:[{name:{namespaceURI:"http://www.lexml.gov.br/1.0",localPart:"Artigo",prefix:"",key:"{http://www.lexml.gov.br/1.0}Artigo",string:"{http://www.lexml.gov.br/1.0}Artigo"},value:{TYPE_NAME:"br_gov_lexml__1.DispositivoType",id:"art1",rotulo:"Art. 1º",lXcontainersOmissis:[{name:{namespaceURI:"http://www.lexml.gov.br/1.0",localPart:"Caput",prefix:"",key:"{http://www.lexml.gov.br/1.0}Caput",string:"{http://www.lexml.gov.br/1.0}Caput"},value:{TYPE_NAME:"br_gov_lexml__1.DispositivoType",id:"art1_cpt",p:[{TYPE_NAME:"br_gov_lexml__1.GenInline",content:[""]}]}}]}}]}}}}};let sx=class extends(pl(Ag)(ol)){constructor(){super(...arguments),this.modo="",this.projetoNorma={},this._timerLoadEmenda=0}createRenderRoot(){return this}setProjetoNorma(t,e,o=!1){this.modo=t,this.projetoNorma=e,this.loadProjetoNorma(o),document.querySelector("lexml-eta-articulacao").style.display="block"}getDispositivosEmenda(){if(this.modo!==Su.EMENDA&&this.modo!==Su.EMENDA_ARTIGO_ONDE_COUBER)return;const t=this.projetoNorma.value.metadado.identificacao.urn,e=Ag.getState().elementoReducer.articulacao;return new Yy(this.modo,t,e).getDispositivosEmenda()}setDispositivosEmenda(t){t&&(this.dispositivosEmenda=t,this.loadEmenda())}getComandoEmenda(){const t=this.projetoNorma.value.metadado.identificacao.urn,e=Ag.getState().elementoReducer.articulacao;return new Zy(t,e).getComandoEmenda()}getProjetoAtualizado(){const t={...this.projetoNorma},e=(o=Ag.getState().elementoReducer.articulacao,{TYPE_NAME:"br_gov_lexml__1.Articulacao",lXhier:Jy(o,{articulacao:{}})});var o;return t.value.projetoNorma[t.value.projetoNorma.norma?"norma":"projeto"].articulacao.lXhier=e.lXhier,t}loadProjetoNorma(t){var e,o,i;let r;if(this.projetoNorma&&this.projetoNorma.value||(this.projetoNorma=ax),this.modo===my.EMENDA_ARTIGO_ONDE_COUBER){const o=null!==(e=nv(this.projetoNorma))&&void 0!==e?e:"";r=iv(ax,!0),r.urn=o;const i=r.articulacao.artigos[0];i.rotulo="Art.",i.numero="1",i.id="art1";const n=new ef;n.tipoEmenda=Su.EMENDA_ARTIGO_ONDE_COUBER,i.situacao=n,t&&r.articulacao.removeFilho(r.articulacao.filhos[0])}else r=iv(this.projetoNorma,this.modo===Su.EMENDA);var n;null===(i=null===(o=document.querySelector("lexml-emenda"))||void 0===o?void 0:o.querySelector("sl-tab"))||void 0===i||i.click(),Ag.dispatch((n=r.articulacao,{type:"ABRIR_ARTICULACAO",classificacao:this.modo,articulacao:n}))}loadEmenda(){this.dispositivosEmenda&&(clearInterval(this._timerLoadEmenda),this._timerLoadEmenda=window.setTimeout((()=>{Ag.dispatch(nc.execute(this.dispositivosEmenda))}),1e3))}render(){return Ms`
    ...
    `}};sx=ns([rl("lexml-eta")],sx);const lx=us`
  sl-radio-group::part(base) {
...
`,mx=class extends Zi{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return Di`
      <span
        part="base"
    ...
    `}};mx.styles=fx,yr([wr({reflect:!0})],mx.prototype,"variant",2),yr([wr({type:Boolean,reflect:!0})],mx.prototype,"pill",2),yr([wr({type:Boolean,reflect:!0})],mx.prototype,"pulse",2),mx=yr([xr("sl-badge")],mx);var vx=ci`
  ${Ji}
...
`,gx=class extends Zi{constructor(){super(...arguments),this.localize=new nn(this),this.tabs=[],this.panels=[],this.hasScrollControls=!1,this.placement="top",this.activation="auto",this.noScrollControls=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver((()=>{this.preventIndicatorTransition(),this.repositionIndicator(),this.updateScrollControls()})),this.mutationObserver=new MutationObserver((t=>{t.some((t=>!["aria-labelledby","aria-controls"].includes(t.attributeName)))&&setTimeout((()=>this.setAriaLabels())),t.some((t=>"disabled"===t.attributeName))&&this.syncTabsAndPanels()})),this.updateComplete.then((()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav);new IntersectionObserver(((t,e)=>{var o;t[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab(null!=(o=this.getActiveTab())?o:this.tabs[0],{emitEvents:!1}),e.unobserve(t[0].target))})).observe(this.tabGroup)}))}disconnectedCallback(){this.mutationObserver.disconnect(),this.resizeObserver.unobserve(this.nav)}show(t){const e=this.tabs.find((e=>e.panel===t));e&&this.setActiveTab(e,{scrollBehavior:"smooth"})}getAllTabs(t=!1){return[...this.shadowRoot.querySelector('slot[name="nav"]').assignedElements()].filter((e=>t?"sl-tab"===e.tagName.toLowerCase():"sl-tab"===e.tagName.toLowerCase()&&!e.disabled))}getAllPanels(){return[...this.body.querySelector("slot").assignedElements()].filter((t=>"sl-tab-panel"===t.tagName.toLowerCase()))}getActiveTab(){return this.tabs.find((t=>t.active))}handleClick(t){const e=t.target.closest("sl-tab");(null==e?void 0:e.closest("sl-tab-group"))===this&&null!==e&&this.setActiveTab(e,{scrollBehavior:"smooth"})}handleKeyDown(t){const e=t.target.closest("sl-tab");if((null==e?void 0:e.closest("sl-tab-group"))===this&&(["Enter"," "].includes(t.key)&&null!==e&&(this.setActiveTab(e,{scrollBehavior:"smooth"}),t.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(t.key))){const e=document.activeElement;if("sl-tab"===(null==e?void 0:e.tagName.toLowerCase())){let o=this.tabs.indexOf(e);"Home"===t.key?o=0:"End"===t.key?o=this.tabs.length-1:["top","bottom"].includes(this.placement)&&"ArrowLeft"===t.key||["start","end"].includes(this.placement)&&"ArrowUp"===t.key?o--:(["top","bottom"].includes(this.placement)&&"ArrowRight"===t.key||["start","end"].includes(this.placement)&&"ArrowDown"===t.key)&&o++,o<0&&(o=this.tabs.length-1),o>this.tabs.length-1&&(o=0),this.tabs[o].focus({preventScroll:!0}),"auto"===this.activation&&this.setActiveTab(this.tabs[o],{scrollBehavior:"smooth"}),["top","bottom"].includes(this.placement)&&qn(this.tabs[o],this.nav,"horizontal"),t.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"})}handleScrollToEnd(){this.nav.scroll({left:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"})}updateScrollControls(){this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=["top","bottom"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth}setActiveTab(t,e){if(e=vr({emitEvents:!0,scrollBehavior:"auto"},e),t!==this.activeTab&&!t.disabled){const o=this.activeTab;this.activeTab=t,this.tabs.map((t=>t.active=t===this.activeTab)),this.panels.map((t=>{var e;return t.active=t.name===(null==(e=this.activeTab)?void 0:e.panel)})),this.syncIndicator(),["top","bottom"].includes(this.placement)&&qn(this.activeTab,this.nav,"horizontal",e.scrollBehavior),e.emitEvents&&(o&&Kr(this,"sl-tab-hide",{detail:{name:o.panel}}),Kr(this,"sl-tab-show",{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach((t=>{const e=this.panels.find((e=>e.name===t.panel));e&&(t.setAttribute("aria-controls",e.getAttribute("id")),e.setAttribute("aria-labelledby",t.getAttribute("id")))}))}syncIndicator(){this.getActiveTab()?(this.indicator.style.display="block",this.repositionIndicator()):this.indicator.style.display="none"}repositionIndicator(){const t=this.getActiveTab();if(!t)return;const e=t.clientWidth,o=t.clientHeight,i=this.getAllTabs(!0),r=i.slice(0,i.indexOf(t)).reduce(((t,e)=>({left:t.left+e.clientWidth,top:t.top+e.clientHeight})),{left:0,top:0});switch(this.placement){case"top":case"bottom":this.indicator.style.width=`${e}px`,this.indicator.style.height="auto",this.indicator.style.transform=`translateX(${r.left}px)`;break;case"start":case"end":this.indicator.style.width="auto",this.indicator.style.height=`${o}px`,this.indicator.style.transform=`translateY(${r.top}px)`}}preventIndicatorTransition(){const t=this.indicator.style.transition;this.indicator.style.transition="none",requestAnimationFrame((()=>{this.indicator.style.transition=t}))}syncTabsAndPanels(){this.tabs=this.getAllTabs(),this.panels=this.getAllPanels(),this.syncIndicator()}render(){return Di`
    ...
    `}};gx.styles=vx,yr([Or(".tab-group")],gx.prototype,"tabGroup",2),yr([Or(".tab-group__body")],gx.prototype,"body",2),yr([Or(".tab-group__nav")],gx.prototype,"nav",2),yr([Or(".tab-group__indicator")],gx.prototype,"indicator",2),yr([Ar()],gx.prototype,"hasScrollControls",2),yr([wr()],gx.prototype,"placement",2),yr([wr()],gx.prototype,"activation",2),yr([wr({attribute:"no-scroll-controls",type:Boolean})],gx.prototype,"noScrollControls",2),yr([wr()],gx.prototype,"lang",2),yr([Gr("noScrollControls",{waitUntilFirstUpdate:!0})],gx.prototype,"updateScrollControls",1),yr([Gr("placement",{waitUntilFirstUpdate:!0})],gx.prototype,"syncIndicator",1),gx=yr([xr("sl-tab-group")],gx);var bx=ci`
  ${Ji}
...
`,yx=0;function xx(){return++yx}var _x=class extends Zi{constructor(){super(...arguments),this.attrId=xx(),this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId}render(){return this.style.display=this.active?"block":"none",Di`
      <div part="base" class="tab-panel" role="tabpanel" aria-hidden=${this.active?"false":"true"}>
        <slot></slot>
      </div>
    `}};_x.styles=bx,yr([wr({reflect:!0})],_x.prototype,"name",2),yr([wr({type:Boolean,reflect:!0})],_x.prototype,"active",2),_x=yr([xr("sl-tab-panel")],_x);var wx=ci`
  ${Ji}
...
`,Ax=class extends Zi{constructor(){super(...arguments),this.localize=new nn(this),this.attrId=xx(),this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1}focus(t){this.tab.focus(t)}blur(){this.tab.blur()}handleCloseClick(){Kr(this,"sl-close")}render(){return this.id=this.id.length>0?this.id:this.componentId,Di`
      <div
        part="base"
    ...
    `}};Ax.styles=wx,yr([Or(".tab")],Ax.prototype,"tab",2),yr([wr({reflect:!0})],Ax.prototype,"panel",2),yr([wr({type:Boolean,reflect:!0})],Ax.prototype,"active",2),yr([wr({type:Boolean})],Ax.prototype,"closable",2),yr([wr({type:Boolean,reflect:!0})],Ax.prototype,"disabled",2),yr([wr()],Ax.prototype,"lang",2),Ax=yr([xr("sl-tab")],Ax);const Ex=Ms`
  <style>
    :root {
...
`,Cx=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),kx=class extends Zi{constructor(){super(...arguments),this.hasSlotController=new Br(this,"icon","suffix"),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}async show(){if(!this.open)return this.open=!0,Wr(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Wr(this,"sl-after-hide")}async toast(){return new Promise((t=>{null===Cx.parentElement&&document.body.append(Cx),Cx.appendChild(this),requestAnimationFrame((()=>{this.clientWidth,this.show()})),this.addEventListener("sl-after-hide",(()=>{Cx.removeChild(this),t(),null===Cx.querySelector("sl-alert")&&Cx.remove()}),{once:!0})}))}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout((()=>this.hide()),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){Kr(this,"sl-show"),this.duration<1/0&&this.restartAutoHide(),await Ln(this.base),this.base.hidden=!1;const{keyframes:t,options:e}=Fn(this,"alert.show");await Dn(this.base,t,e),Kr(this,"sl-after-show")}else{Kr(this,"sl-hide"),clearTimeout(this.autoHideTimeout),await Ln(this.base);const{keyframes:t,options:e}=Fn(this,"alert.hide");await Dn(this.base,t,e),this.base.hidden=!0,Kr(this,"sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}render(){return Di`
  ...
  `,ns([sl()],Tx.prototype,"elementoSelecionado",void 0),ns([sl()],Tx.prototype,"acoesMenu",void 0),Tx=ns([rl("lexml-ajuda")],Tx);let qx=class extends ol{show(){this.slDialog.show()}render(){return Ms`
      <style>
        :host {
          font-family: var(--sl-font-sans);
        }
    ...
    `}};ns([cl("sl-dialog")],qx.prototype,"slDialog",void 0),qx=ns([rl("lexml-ajuda-modal")],qx);let Px=class extends ol{atualizarComandoEmenda(t){this.lexmlComandoEmenda.emenda=t}show(){this.slDialog.show()}render(){return Ms`
      <style>
        :host {
          font-family: var(--sl-font-sans);
        }
    ...
    `}};ns([cl("sl-dialog")],Px.prototype,"slDialog",void 0),ns([cl("#comando-emenda-modal")],Px.prototype,"lexmlComandoEmenda",void 0),ns([al({type:Object})],Px.prototype,"comandoEmenda",void 0),Px=ns([rl("lexml-emenda-comando-modal")],Px);let Dx=class extends ol{show(){this.slDialog.show()}render(){return Ms`
      <style>
        :host {
          font-family: var(--sl-font-sans);
        }

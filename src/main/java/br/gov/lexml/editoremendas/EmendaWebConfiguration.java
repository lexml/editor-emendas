...
public class EmendaWebConfiguration {
	...
	@Bean
	public FilterRegistrationBean someFilterRegistration(HttpFilter headersFilter) {
	    FilterRegistrationBean registration = new FilterRegistrationBean();
	    registration.setFilter(headersFilter);
	    registration.addUrlPatterns("/", "/index.html");
	    registration.setName("Headers-Filter");
